...
def Display():
    if(os.path.isfile('Phone_Directory.txt') == 0):
        print('''Sorry you Don't have any Contacts in your Phone Address Book.
                 Please Create it!!!!''')
...
def Search():
    ...
    for line in f:
        if name in line:
            ...
            found = False
    if (found == True):
        print('The Name of the Person Exist in Directory:')
        print(line.replace(', ', ': '))
    else:
        print('''The Name Doesn't Exist in Directory''')
...
if (os.path.isfile('Phone_Directory.txt') == 0):
    ...
    print('Already Your Book has Some Contacts')
